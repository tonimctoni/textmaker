...
public:
    ...
    TahnPerceptronBlock(size_t time_steps=0) noexcept:layer_states(time_steps),ms_weights(1.0), ms_bias(1.0),mns_weights(1.0), mns_bias(1.0), weight_gradient_accumulator(0.0), bias_gradient_accumulator(0.0)
    {
...
public:
    ...
    SoftmaxBlock(size_t time_steps=0) noexcept:layer_states(time_steps),ms_weights(1.0), ms_bias(1.0),mns_weights(1.0), mns_bias(1.0), weight_gradient_accumulator(0.0), bias_gradient_accumulator(0.0)
    {
        weights.randomize_for_nn(input_size+1);
        bias.randomize_for_nn(input_size+1);
    }
