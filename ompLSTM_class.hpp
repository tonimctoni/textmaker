    ...
    inline void calc(const Matrix<1,input_size> &X, size_t time_step) noexcept
    {
        ...
        #pragma omp parallel sections
        {
            #pragma omp section
            {
                ...
                if(time_step!=0)lstm_states[time_step].state_g.add_a_dot_b(lstm_states[time_step-1].state_h, weights_hg);
            ...
            #pragma omp section
            {
                ...
                if(time_step!=0)lstm_states[time_step].state_i.add_a_dot_b(lstm_states[time_step-1].state_h, weights_hi);
            ...
            #pragma omp section
            {
                ...
                if(time_step!=0)lstm_states[time_step].state_f.add_a_dot_b(lstm_states[time_step-1].state_h, weights_hf);
            ...
            #pragma omp section
            {
                ...
                if(time_step!=0)lstm_states[time_step].state_o.add_a_dot_b(lstm_states[time_step-1].state_h, weights_ho);
    ...
    inline void accumulate_gradients(const Matrix<1,input_size> &X, size_t time_step) noexcept
    {
        ...
        #pragma omp parallel sections
        {
            #pragma omp section
            {
                ...
                if(time_step!=0)weights_hg_gradient_acc.add_at_dot_b(lstm_states[time_step-1].state_h, lstm_states[time_step].delta_g);
            ...
            #pragma omp section
            {
                ...
                if(time_step!=0)weights_hi_gradient_acc.add_at_dot_b(lstm_states[time_step-1].state_h, lstm_states[time_step].delta_i);
            ...
            #pragma omp section
            {
                ...
                if(time_step!=0)weights_hf_gradient_acc.add_at_dot_b(lstm_states[time_step-1].state_h, lstm_states[time_step].delta_f);
            ...
            #pragma omp section
            {
                ...
                if(time_step!=0)weights_ho_gradient_acc.add_at_dot_b(lstm_states[time_step-1].state_h, lstm_states[time_step].delta_o);
