...
int main()
{
    ...
    using Block02=AdamLSTMBlock<reduced_input_size, first_mem_cell_size>;
    using Block03=AdamLSTMBlock<first_mem_cell_size, second_mem_cell_size>;
    using Block04=AdamLSTMBlock<second_mem_cell_size, third_mem_cell_size>;
