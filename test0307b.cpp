...
int main()
{
    ...
    size_t iteration=0;
    {
        ...
        else
        {
            ...
            for(size_t iteration=0;error>0.00000001;iteration++)
            {
                ...
                perceptronblock->update_weights(X.get(),0,learning_rate);
                softmaxblock2->update_weights(perceptronblock->get_output(0),0,learning_rate);
    ...
    for(;;iteration++)
    {
        ...
        for(size_t i=0;i<asoiaf_length;i++)
        {
            ...
            perceptronblock->update_weights(X.get(), i, learning_rate);
            ...
            lstmblock3->update_weights(lstmblock2->get_output(i), i, learning_rate);
            softmaxblock->update_weights(lstmblock3->get_output(i), i, learning_rate);
        }
