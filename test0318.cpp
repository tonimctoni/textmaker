...
int main()
{
    ...
    using Block01=RMSPropRELUBlock<input_size,reduced_input_size>;
    using Block02=RMSPropRELULSTMBlock<reduced_input_size, first_mem_cell_size>;
    using Block03=RMSPropRELULSTMBlock<first_mem_cell_size, second_mem_cell_size>;
    using Block04=RMSPropRELULSTMBlock<second_mem_cell_size, third_mem_cell_size>;
