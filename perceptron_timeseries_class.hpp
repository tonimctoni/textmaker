...
public:
    BaseTahnPerceptronBlock(size_t time_steps=0) noexcept:layer_states(time_steps)
    {
...
public:
    ...
    :BaseTahnPerceptronBlock<input_size, output_size>(time_steps),moment_weights(0.0),moment_bias(0.0), weight_gradient_accumulator(0.0), bias_gradient_accumulator(0.0)
    {
    }
...
public:
    ...
    using BaseTahnPerceptronBlock<input_size, output_size>::weights;
    using BaseTahnPerceptronBlock<input_size, output_size>::bias;
    SpeedyTahnPerceptronBlock(size_t time_steps=0) noexcept:BaseTahnPerceptronBlock<input_size, output_size>(time_steps),moment_weights(0.0),moment_bias(0.0),ms_weights(1.0), ms_bias(1.0), weight_gradient_accumulator(0.0), bias_gradient_accumulator(0.0)
    {
    }
...
public:
    ...
    using BaseTahnPerceptronBlock<input_size, output_size>::weights;
    using BaseTahnPerceptronBlock<input_size, output_size>::bias;
    RMSPropTahnPerceptronBlock(size_t time_steps=0) noexcept:BaseTahnPerceptronBlock<input_size, output_size>(time_steps),ms_weights(1.0), ms_bias(1.0), weight_gradient_accumulator(0.0), bias_gradient_accumulator(0.0)
    {
        weights.randomize_for_nn(input_size+1);
        bias.randomize_for_nn(input_size+1);
    }
...
public:
    ...
    using BaseTahnPerceptronBlock<input_size, output_size>::weights;
    using BaseTahnPerceptronBlock<input_size, output_size>::bias;
    AdamTahnPerceptronBlock(size_t time_steps=0) noexcept:BaseTahnPerceptronBlock<input_size, output_size>(time_steps),ms_weights(1.0), ms_bias(1.0),mns_weights(1.0), mns_bias(1.0), weight_gradient_accumulator(0.0), bias_gradient_accumulator(0.0)
    {
    }
